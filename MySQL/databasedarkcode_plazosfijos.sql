...
--
-- Table structure for table `plazosfijos`
--
...
--
-- Dumping data for table `plazosfijos`
--

LOCK TABLES `plazosfijos` WRITE;
/*!40000 ALTER TABLE `plazosfijos` DISABLE KEYS */;
/*!40000 ALTER TABLE `plazosfijos` ENABLE KEYS */;
UNLOCK TABLES;
