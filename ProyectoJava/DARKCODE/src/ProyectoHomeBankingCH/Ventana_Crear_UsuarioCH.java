...
public class Ventana_Crear_UsuarioCH extends javax.swing.JFrame {

    DecimalFormat df = new DecimalFormat("###,###,###,###.##");

    public Ventana_Crear_UsuarioCH() {
        initComponents();
    ...
    public void validar() {
        ...
        if (txtNombre.getText().isEmpty()) {
            lblNombre.setText("* 必填字段");
        } else {
            lblNombre.setText("");
        }

        if (txtApellido.getText().isEmpty()) {
            lblApellido.setText("* 必填字段");
        } else {
            lblApellido.setText("");
        }

        if (txtUsuario.getText().isEmpty()) {
            lblUsuario.setText("* 必填字段");
        } else {
            lblUsuario.setText("");
        }
        if (txtCorreo.getText().isEmpty()) {
            lblCorreo.setText("* 必填字段");
        } else if (!txtCorreo.getText().contains("@") || !txtCorreo.getText().contains(".")) {
            lblCorreo.setText("* 无效邮箱");
        } else {
            lblCorreo.setText("");
        }

        if (txtContraseña.getText().isEmpty()) {
            lblContraseña.setText("* 必填字段");
        } else {
            lblContraseña.setText("");
        }

        if (txtDNI.getText().isEmpty() || txtApellido.getText().isEmpty() || txtNombre.getText().isEmpty() || txtUsuario.getText().isEmpty() || txtContraseña.getText().isEmpty() || txtCorreo.getText().isEmpty() || lblCorreo.getText().equals("* 无效邮箱")) {
            btnGuardar.setEnabled(false);
        } else {
            btnGuardar.setEnabled(true);
        }
        Ventana_Crear_UsuarioCH ol = new Ventana_Crear_UsuarioCH();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setFont(new java.awt.Font("Krungthep", 0, 15)); // NOI18N
        jLabel7.setText("身份证");
        ...
        jLabel16.setFont(new java.awt.Font("Krungthep", 0, 15)); // NOI18N
        jLabel16.setText("邮箱");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (i > 0) {
            ...
            JOptionPane.showMessageDialog(this, "无法保存");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Crear_UsuarioCH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Crear_UsuarioCH().setVisible(true);
            }
        });
    }
