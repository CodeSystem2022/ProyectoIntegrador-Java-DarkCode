...
public class Ventana_Transferencia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Nueva transferencia");
        ...
        jLabel3.setText("Últimas transferencias");
        ...
        jTableMovimientos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha/Hora", "Beneficiario", "CBU/ALIAS/CVU", "Conceptos", "Monto"
            }
        ) {
        ...
        jLabel1.setText("¿Deseas enviar dinero?");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        Ventana_Transferencia_Nueva VNT = new Ventana_Transferencia_Nueva();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Transferencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Transferencia().setVisible(true);
            }
        });
    }
