...
import ProyectoHomeBanking.Ventana_Inicio;
import ProyectoHomeBankingEN.Window_Login;
import java.awt.Color;
import java.awt.event.KeyEvent;
import java.text.DecimalFormat;
import javax.swing.JOptionPane;

public class Ventana_InicioCH extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(BtnEresNuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 430, 100, -1));
        ...
        jLabel6.setText("你好， 我已经有帐户");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 270, -1, -1));

        jLabel7.setFont(new java.awt.Font("Krungthep", 0, 16)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 102, 153));
        jLabel7.setText("选择语言");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, 90, -1));
        ...
        btnespañol.setBackground(new java.awt.Color(0, 102, 153));
        btnespañol.setFont(new java.awt.Font("Krungthep", 0, 14)); // NOI18N
        btnespañol.setForeground(new java.awt.Color(255, 255, 255));
        btnespañol.setText("Español");
        btnespañol.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jPanel1.add(btnespañol, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 70, 90, -1));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 237, 260, -1));
    ...
    private void txtUsuarioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtUsuarioMousePressed
        ...
        if (txtUsuario.getText().equals("请输入用户名")) {
            txtUsuario.setText("");
    ...
    private void BtnEresNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnEresNuevoMouseClicked
        // TODO add your handling code here:
        Ventana_Crear_UsuarioCH VNU = new Ventana_Crear_UsuarioCH();
        VNU.setVisible(true);
        dispose();
    ...
    private void BtnIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnIngresarMouseClicked
        ...
        if (txtUsuario.getText().equals("root") && txtPassword.getText().equals("root")) {
            ...
            ventana.lblNombre.setText("欢迎: " + busqueda_nombre);
            ventana.setVisible(true);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Create an account, it's free");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_InicioCH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_InicioCH().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JButton btnespañol;
