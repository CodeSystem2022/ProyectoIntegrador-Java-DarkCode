...
public class Ventana_MenuInicioCH extends javax.swing.JFrame {
    ...
    public Ventana_MenuInicioCH() {
        initComponents();
        desplace = new Desface();
        desplace.desplazarIzquierda(MenuPlegable, MenuPlegable.getX(), -120, 10, 10);
        this.setLocationRelativeTo(null);
        Time tiempo = new Time();
        lbtiempo.setText(tiempo.fechahora2);
        setTitle("DARKCODE 支付中心");
    ...
    private void initComponents() {
        ...
        MenuPlegable.add(MInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 160, 44));

        MTrasnferencia.setFont(new java.awt.Font("Krungthep", 1, 15)); // NOI18N
        ...
        MenuPlegable.add(MInversión, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 149, 180, 44));

        MPagos.setFont(new java.awt.Font("Krungthep", 1, 15)); // NOI18N
        ...
        MenuPlegable.add(MPagos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 190, 44));

        MPréstamos.setFont(new java.awt.Font("Krungthep", 1, 15)); // NOI18N
        ...
        MenuPlegable.add(MPréstamos, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 304, 180, 44));

        MSimulador.setFont(new java.awt.Font("Krungthep", 1, 15)); // NOI18N
        ...
        MenuPlegable.add(MSimulador, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 190, 44));

        MCerrarSesión.setFont(new java.awt.Font("Krungthep", 1, 15)); // NOI18N
        ...
        MenuPlegable.add(MCerrarSesión, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 472, 180, 42));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(lblMostrarsaldoP, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(85, 85, 85)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(CAE, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void MCerrarSesiónMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MCerrarSesiónMouseClicked
        ...
        mod.setUsuario(null);
        Ventana_InicioCH VIN = new Ventana_InicioCH();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_MenuInicioCH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_MenuInicioCH().setVisible(true);
            }
        });
    }
