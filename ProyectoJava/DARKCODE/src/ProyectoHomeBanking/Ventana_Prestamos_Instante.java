...
public class Ventana_Prestamos_Instante extends javax.swing.JFrame {
    ...
    public Ventana_Prestamos_Instante() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Préstamos al instante");

        jLabel32.setFont(new java.awt.Font("Krungthep", 0, 14)); // NOI18N
        jLabel32.setText("Dinero a pedir");
        ...
        CajaCalcular1.setText("Calcular");
        ...
        btnconfirmar.setText("Pedir préstamo");
    ...
    private void btnconfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnconfirmarActionPerformed
        ...
        String saldo = Double.toString(sa.prestamos(mostrar_saldo, monto));
        ...
        JOptionPane.showMessageDialog(this, "La transacción se ha realizado.");
        Ventana_Prestamos v6 = new Ventana_Prestamos();
        v6.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Prestamos_Instante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Prestamos_Instante().setVisible(true);
            }
        });
    }
