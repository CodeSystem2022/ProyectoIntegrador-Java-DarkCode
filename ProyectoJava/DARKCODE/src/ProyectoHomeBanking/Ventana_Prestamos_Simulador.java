...
public class Ventana_Prestamos_Simulador extends javax.swing.JFrame {

    DecimalFormat df = new DecimalFormat("###,###,###.##");
    Metodos_sql metodo = new Metodos_sql();
    ModeloTransferencia mod = General.modelotransferencia;

    public Ventana_Prestamos_Simulador() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SIMULA TU PRÉSTAMO");

        jLabel2.setFont(new java.awt.Font("Krungthep", 1, 14)); // NOI18N
        jLabel2.setText("Ingrese el dinero a solicitar");
        ...
        jLabel4.setText("Monto a recibir");

        jLabel5.setFont(new java.awt.Font("Krungthep", 1, 14)); // NOI18N
        jLabel5.setText("Cuota mensual de");
        ...
        btnPedirP.setText("Solicitar préstamo");
    ...
    private void btnPedirPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPedirPActionPerformed
        // TODO add your handling code here:
        Ventana_Prestamos_Instante v4 = new Ventana_Prestamos_Instante();
        v4.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Prestamos_Simulador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Prestamos_Simulador().setVisible(true);
            }
        });
    }
