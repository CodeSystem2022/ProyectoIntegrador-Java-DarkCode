...
public class Window_Create_User extends javax.swing.JFrame {

    DecimalFormat df = new DecimalFormat("###,###,###,###.##");

    public Window_Create_User() {
        initComponents();
    ...
    public void validar() {
        ...
        if (txtDNI.getText().isEmpty()) {
            lblDNI.setText("* Mandatory field");
        } else {
            lblDNI.setText("");
        }

        if (txtNombre.getText().isEmpty()) {
            lblNombre.setText("* Mandatory field");
        } else {
            lblNombre.setText("");
        }

        if (txtApellido.getText().isEmpty()) {
            lblApellido.setText("* Mandatory field");
        } else {
            lblApellido.setText("");
        }

        if (txtUsuario.getText().isEmpty()) {
            lblUsuario.setText("* Mandatory field");
        } else {
            lblUsuario.setText("");
        }
        if (txtCorreo.getText().isEmpty()) {
            lblCorreo.setText("* Mandatory field");
        } else if (!txtCorreo.getText().contains("@") || !txtCorreo.getText().contains(".")) {
            lblCorreo.setText("* Invalid e-mail");
        } else {
            lblCorreo.setText("");
        }

        if (txtContraseña.getText().isEmpty()) {
            lblContraseña.setText("* Mandatory field");
        } else {
            lblContraseña.setText("");
        }

        if (txtDNI.getText().isEmpty() || txtApellido.getText().isEmpty() || txtNombre.getText().isEmpty() || txtUsuario.getText().isEmpty() || txtContraseña.getText().isEmpty() || txtCorreo.getText().isEmpty() || lblCorreo.getText().equals("* Invalid e-mail")) {
            btnGuardar.setEnabled(false);
        } else {
            btnGuardar.setEnabled(true);
        }
        Window_Create_User ol = new Window_Create_User();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Join the digital future");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (i > 0) {
            JOptionPane.showMessageDialog(this, "Saved correctly");
            Window_Login ventana = new Window_Login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window_Create_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Window_Create_User().setVisible(true);
            }
        });
    }
