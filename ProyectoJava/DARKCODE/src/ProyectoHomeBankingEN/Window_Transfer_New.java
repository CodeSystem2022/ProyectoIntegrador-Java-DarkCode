...
public class Window_Transfer_New extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Which account are you sending money from?");
        ...
        jLabel3.setText("How much are you sending?");

        jLabel7.setFont(new java.awt.Font("Krungthep", 0, 14)); // NOI18N
        jLabel7.setText("CBU/ALIAS/CVU (Arg.)");

        jComboBoxConcepto.setFont(new java.awt.Font("Krungthep", 0, 13)); // NOI18N
        jComboBoxConcepto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rent", "Instalments", "Expenses", "Bills", "Loans", "Insurance", "Other" }));

        jLabel9.setFont(new java.awt.Font("Krungthep", 0, 14)); // NOI18N
        jLabel9.setText("Why are you sending this money?");
        ...
        jLabel4.setText("Memo (optional)");

        jLabel10.setFont(new java.awt.Font("Krungthep", 0, 14)); // NOI18N
        jLabel10.setText("Beneficiary's name");
        ...
        jLabel5.setText("Who are you sending money to?");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (mostrar_saldo >= monto) {
            ...
            Window_Transferencia ventana = new Window_Transferencia();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window_Transfer_New.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
