...
public class Window_Simulador_R_PlazoFijo extends javax.swing.JFrame {

    Time tiempo = new Time();
    Metodos_sql metodo = new Metodos_sql();
    ModeloTransferencia mod = General.modelotransferencia;

    public Window_Simulador_R_PlazoFijo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fixed deposit investment calculator");
        ...
        jLabel12.setText("Estimated returns");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window_Simulador_R_PlazoFijo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Window_Simulador_R_PlazoFijo().setVisible(true);
            }
        });
    }
