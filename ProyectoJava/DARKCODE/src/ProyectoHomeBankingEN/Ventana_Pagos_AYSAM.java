...
public class Ventana_Pagos_AYSAM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAYSAM = new javax.swing.JLabel();
        ...
        lblAYSAM.setFont(new java.awt.Font("Krungthep", 0, 12)); // NOI18N
        lblAYSAM.setForeground(new java.awt.Color(255, 255, 255));
        lblAYSAM.setText("1300");
        panelRound5.add(lblAYSAM, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 70, 20));
        ...
        jLabel28.setText("PAYED");
        panelRound5.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 60, 70, -1));

        jLabel27.setFont(new java.awt.Font("Krungthep", 0, 12)); // NOI18N
        jLabel27.setForeground(new java.awt.Color(102, 255, 102));
        jLabel27.setText("PAYED");
        panelRound5.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 90, 70, -1));

        jLabel26.setFont(new java.awt.Font("Krungthep", 0, 12)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(255, 51, 51));
        jLabel26.setText("OVERDUE");
    ...
    private void pagar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pagar1ActionPerformed
        ...
        double pagoaysam = Double.parseDouble(lblAYSAM.getText());
        ...
        if (CHECK_PAGO.isSelected()) {
            ...
            if (mostrar_saldo >= pagoaysam) {
                ...
                metodos.guardarPagos(mod.getUsuario(), tiempo.fechahora, lblAYSAM.getText(), CTNET, ECOGAS, EDEMSA);
            ...
            JOptionPane.showMessageDialog(null, "Select to procede");
        }
    ...
    private javax.swing.JLabel lblAYSAM;
