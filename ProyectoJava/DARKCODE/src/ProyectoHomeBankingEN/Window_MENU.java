...
public class Window_MENU extends javax.swing.JFrame {
    Metodo_sql.Metodos_Saldo_sql saldos = new Metodos_Saldo_sql();
    ...
    private void initComponents() {
        ...
        MTrasnferencia.setText("Send money              ");
        ...
        MInversión.setText("Investments                ");
        ...
        MenuPlegable.add(MSimulador, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 387, 180, 44));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(CA, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lblMostrarsaldoP, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE))
                        .addGap(85, 85, 85)
    ...
    private void MTrasnferenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MTrasnferenciaMouseClicked
        ...
        Window_Transferencia VT = new Window_Transferencia();
    ...
    private void MPréstamosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MPréstamosMouseClicked
        String busqueda_nombre = metodo.buscarSoloNombre(mod.getUsuario());
        Window_PrestamosEN VPS = new Window_PrestamosEN();
    ...
    private void MCerrarSesiónMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MCerrarSesiónMouseClicked
        ...
        mod.setUsuario(null);
        Window_Login VIN = new Window_Login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window_MENU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Window_MENU().setVisible(true);
            }
        });
    }
