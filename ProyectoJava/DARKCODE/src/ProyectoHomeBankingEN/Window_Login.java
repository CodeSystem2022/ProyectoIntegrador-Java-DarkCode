...
public class Window_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("GET READY FOR A NEW EXPERIENCE");
        ...
        jLabel6.setText("Hello there, welcome back");
        ...
        btnEspañol.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnEspañolMouseClicked(evt);
            }
        });
        ...
        jPanel1.add(btnEspañol, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 40, 90, -1));
        ...
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 220, 420, 10));
    ...
    private void BtnEresNuevoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnEresNuevoMouseClicked
        // TODO add your handling code here:
        Window_Create_User VNU = new Window_Create_User();
        VNU.setVisible(true);
        dispose();
    ...
    private void BtnIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnIngresarMouseClicked
        ...
        if (txtUsuario.getText().equals("root") && txtPassword.getText().equals("root")) {
            ...
            ventana.lblNombre.setText("Welcome: " + busqueda_nombre);
            ventana.setVisible(true);
            this.dispose();
        } else {
    ...
    private void btnEspañolMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEspañolMouseClicked

    }//GEN-LAST:event_btnEspañolMouseClicked
